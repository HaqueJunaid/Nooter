                        ...
                        <div className="mx-auto max-w-5xl px-6">
                            <div className="sm:mx-auto lg:mr-auto lg:mt-0">
                                ...
                                <TextEffect
                                    ...
                                    Take notes, organize your thoughts, and never lose an idea again with Nooter's powerful note-taking platform.
                                </TextEffect>
                                ...
                                <AnimatedGroup
                                    ...
                                    <div
                                        ...
                                        <Button
                                            ...
                                            <Link href="/dashboard">
                                                <span className="text-nowrap">Start Writting</span>
                                            </Link>
                                        </Button>
                                    </div>
                                </AnimatedGroup>
