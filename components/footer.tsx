        ...
        <footer className="py-16 md:py-32">
            <div className="mx-auto max-w-5xl px-6">
                <Link
                    ...
                    <h1 className='text-2xl font-bold'>Nooter</h1>
                </Link>
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} Nooter, All rights reserved</span>
            </div>
        </footer>
    )
}
